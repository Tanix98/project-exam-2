...
function SingleVenue() {
    ...
    return (
        ...
        >
            <div>
                <div id='venueImgContainer' className='rounded shadow-sm'>
                    <img
                        className='venueImg img-fluid'
                        src={data.media ? data.media : noImg}
                        alt={data.name}
                    />
                </div>
                <div className='mt-3'>
                ...
                >
                    ...
                    <div className='d-flex flex-column'>
                        <p className='mb-auto'>Owner Name</p>
                ...
                <div className='bg-white shadow-sm rounded d-flex flex-column gap-3 p-3'>
                    <div className='d-flex align-items-center gap-3'>
                        ...
                        <p className='undertitle-p'>Wi-Fi included</p>
                    </div>
                    <div className='d-flex align-items-center gap-3 text-muted'>
                        ...
                        <p className='undertitle-p'>Parking not included</p>
                    </div>
                    <div className='d-flex align-items-center gap-3 text-muted'>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                        ...
                        <p className='undertitle-p'>Breakfast not included</p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p className='undertitle-p'>Pets allowed</p>
                    </div>
                    <div className='d-flex align-items-center gap-3'>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                        ...
                        <p className='undertitle-p'>{'Up to 3 guests'}</p>
                    </div>
                    ...
                    <div className='d-flex align-items-center gap-3'>
                        ...
                        <p className='undertitle-p'>address, city, country</p>
                    </div>
                </div>
                <div className='my-3'>
...
/* Code to get venue owner avatar and name, does not work for some reason.
    <Link to={{ pathname: `/profile/${venue.owner.name}` }} className='venueOwner mt-1 d-flex align-items-center gap-1'>
                    {data.owner.avatar ? (
                        <img
...
/* Code to get venue meta data, does not work for some reason
<div className='bg-white shadow-sm rounded d-flex flex-column gap-3 p-3'>
                    <div className={data.meta.wifi ? 'd-flex align-items-center gap-3' : 'd-flex align-items-center gap-3 text-muted'}>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='24'
                            height='24'
                    ...
                    <div className={data.meta.parking ? 'd-flex align-items-center gap-3' : 'd-flex align-items-center gap-3 text-muted'}>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='24'
                            height='24'
                    ...
                    <div className={data.meta.breakfast ? 'd-flex align-items-center gap-3' : 'd-flex align-items-center gap-3 text-muted'}>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='24'
                            height='24'
                    ...
                    <div
                        className={data.meta.pets ? 'd-flex align-items-center gap-3' : 'd-flex align-items-center gap-3 text-muted'}
                        id='venueMeta'
                    >
                        <FontAwesomeIcon icon={faDog} />
                        <p className='undertitle-p'>
